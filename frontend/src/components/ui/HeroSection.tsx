					...
					>
						<div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-500/10 border border-amber-500/30 rounded-full mb-6">
							...
							<span className="text-amber-400 text-sm font-medium">
								Gold Coast's Most Affordable Rentals
							</span>
						</div>
						...
						<p className="text-lg text-slate-300 mb-8 max-w-xl leading-relaxed">
							...
							the Gold Coast. Perfect for students, workers, new arrivals, and
							anyone who needs a car without the big cost of buying one.
						</p>
						...
						<div className="flex flex-wrap gap-4 mb-12">
							<Link to={createPageUrl("CarsAvailable")}>
								<Button
									size="lg"
									className="bg-amber-500 hover:bg-amber-600 text-slate-900 font-semibold px-8 h-14 text-lg rounded-xl shadow-lg shadow-amber-500/25 transition-all hover:shadow-xl hover:shadow-amber-500/30"
								>
									View Our Cars
